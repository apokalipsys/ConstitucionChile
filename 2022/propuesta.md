...
\begin{itemize}
\item[a)] Ejercer funciones de gobierno y administración dentro de la comuna y en el ámbito de sus competencias.

\item[b)] La dictación de normas generales y obligatorias en materias de carácter comunal, con arreglo a la Constitución y las leyes.

\item[c)] La creación, prestación, organización y administración de los servicios públicos municipales en el ámbito de sus funciones, conforme a la Constitución y la ley.

\item[d)] El desarrollo sostenible e integral de la comuna.

\item[e)] La protección de los ecosistemas comunales y los derechos de la naturaleza.

\item[f)] Ejercer las acciones pertinentes en resguardo de la naturaleza y sus derechos reconocidos por esta Constitución y la ley.

\item[g)] La ejecución de los mecanismos y acciones de protección ambiental en la forma que determinen la Constitución, la ley, los instrumentos de gestión ambiental y normas afines.

\item[h)] La conservación, la custodia y el resguardo de los patrimonios culturales y naturales.

\item[i)] El fomento y la protección a las culturas, las artes y los patrimonios culturales y naturales, así como la investigación y la formación artística en sus territorios.

\item[j)] Garantizar la participación popular y el fortalecimiento de la democracia.

\item[k)] Desarrollar, con el nivel regional y central, actividades y servicios en materias de educación, salud, vivienda, turismo, recreación, deporte y las demás que establezca la ley.

\item[l)] La construcción de obras que demande el progreso local en el marco de sus atribuciones.

\item[m)] El desarrollo estratégico de la comuna mediante el plan de desarrollo comunal.
...
\item[p)] El fomento de la reintegración y reinserción de las personas en situación de calle que así lo requieran, mediante la planificación, coordinación y ejecución de programas al efecto.

\item[q)] Gestionar la reducción de riesgos frente a desastres.

\item[r)] El desarrollo de aseo y ornato de la comuna.

\item[s)] La promoción de la seguridad ciudadana.

\item[t)] Las demás competencias que determinen la Constitución y la ley. Las leyes deberán reconocer las diferencias existentes entre los distintos tipos de comunas y municipalidades, velando por la equidad, inclusión y cohesión territorial.
\end{itemize}
...
\begin{itemize}
\item[a)] La organización del Gobierno regional, en conformidad con la Constitución y su estatuto.

\item[b)] La organización político-administrativa y financiera de la región autónoma.

\item[c)] Coordinar y delegar las competencias constitucionales compartidas con las demás entidades territoriales.

\item[d)] La política regional de vivienda, urbanismo, salud, transporte y educación, en coordinación con las políticas, los planes y los programas nacionales, respetando la universalidad de los derechos garantizados por esta Constitución.

\item[e)] La creación de empresas públicas regionales por parte de los órganos de la región autónoma competentes, conforme a los procedimientos regulados en la ley.

\item[f)] Ejercer autónomamente la administración y coordinación de todos los servicios públicos de su dependencia.

\item[g)] La conservación, preservación, protección y restauración de la naturaleza, del equilibrio ecológico y el uso racional del agua y los demás elementos naturales de su territorio.

\item[h)] La regulación y administración de los bosques, las reservas y los parques de las áreas silvestres protegidas y cualquier otro predio fiscal que se considere necesario para el cuidado de los servicios ecosistémicos que se otorgan a las comunidades, en el ámbito de sus competencias.

\item[i)] La planificación, el ordenamiento territorial y el manejo integrado de cuencas.

\item[j)] Establecer una política permanente de desarrollo sostenible y armónico con la naturaleza.

\item[k)] Aprobar, mediando procesos de participación ciudadana, los planes de descontaminación ambientales de la región autónoma.

\item[l)] Promover la participación popular en asuntos de interés regional.

\item[m)] El desarrollo de la investigación, la tecnología y las ciencias.
...
\item[p)] La promoción y el fomento del deporte, el ocio y la recreación.

\item[q)] La promoción y ordenación del turismo en el ámbito territorial de la región autónoma, en coordinación con la comuna autónoma.

\item[r)] El fomento del desarrollo social, productivo y económico de la región autónoma, en coordinación con las políticas, los planes y los programas nacionales.

\item[s)] Establecer contribuciones y tasas dentro de su territorio previa autorización por ley.

\item[t)] Participar en acciones de cooperación internacional, dentro de los marcos establecidos por los tratados y los convenios vigentes.

\item[u)] Las demás competencias que determinen la Constitución y ley.
\end{itemize}
...
\begin{itemize}
\item[a)] Ejercer la potestad reglamentaria en todas aquellas materias que se encuentren dentro del ámbito de sus competencias, en conformidad con la Constitución, la ley y el estatuto regional.

\item[b)] Organizar, administrar, supervigilar y fiscalizar los servicios públicos de la región autónoma y coordinarse con el Gobierno respecto de aquellos que detenten un carácter nacional y que funcionen en la región.

\item[c)] Proponer a la asamblea regional la creación de empresas públicas regionales o la participación en empresas regionales para la gestión de servicios de su competencia, según lo dispuesto en la Constitución, la ley y el estatuto regional.

\item[d)] Preparar y presentar ante la asamblea regional el plan regional de ordenamiento territorial y los planes de desarrollo urbano de las áreas metropolitanas, en conformidad con el estatuto regional y la ley.

\item[e)] Presentar ante la asamblea regional los planes de manejo integrado de cuencas acordados en los respectivos consejos de cuencas, en conformidad con la ley.

\item[f)] Convocar a referendos y plebiscitos regionales en virtud de lo previsto en la Constitución, el estatuto regional y la ley.

\item[g)] Establecer sistemas de gestión de crisis entre los órganos que tienen asiento en la región autónoma, que incluyan, a lo menos, su preparación, prevención, administración y manejo.

\item[h)] Preparar y presentar ante la asamblea regional el plan de desarrollo regional, conforme al estatuto regional.

\item[i)] Celebrar actos y contratos en los que tenga interés.

\item[j)] Adoptar e implementar políticas públicas que fomenten y promocionen el desarrollo social, productivo, económico y cultural de la región autónoma, especialmente en ámbitos de competencia de la región autónoma.

\item[k)] Promover la innovación, la competitividad y la inversión en la respectiva región autónoma.

\item[l)] Elaborar y presentar ante la asamblea regional el proyecto de presupuesto regional, conforme a esta Constitución y al estatuto regional.

\item[m)] Administrar y ejecutar la planificación presupuestaria sobre la destinación y uso del presupuesto regional.
...
\item[p)] Las demás atribuciones que señalen la Constitución, la ley y el estatuto regional.
\end{itemize}
...
\begin{itemize}
\item[a)] Dictar su reglamento interno de funcionamiento.

\item[b)] Dictar las normas regionales que hagan aplicables las leyes de acuerdo regional.

\item[c)] Iniciar en materias de interés regional el trámite legislativo ante la Cámara de las Regiones.

\item[d)] Solicitar al Congreso de Diputadas y Diputados la transferencia de la potestad legislativa en materias de interés de la región autónoma.

\item[e)] Ejercer la potestad reglamentaria en conjunto con quien dirija el gobierno regional en materias de su competencia y dictar los reglamentos de ejecución de ley cuando esta lo encomiende.

\item[f)] Administrar sus bienes y patrimonio propio.

\item[g)] Aprobar, rechazar o modificar la inversión de los recursos de los fondos solidarios que se creen y otros recursos públicos que disponga la ley.

\item[h)] Fiscalizar los actos del gobierno regional de acuerdo con el procedimiento establecido en el estatuto regional.

\item[i)] Fiscalizar los actos de la administración regional, para lo cual podrá requerir información de autoridades o jefaturas que desempeñen sus funciones en la región autónoma, citar a funcionarios públicos o autoridades regionales y crear comisiones especiales.

\item[j)] Solicitar a la gobernadora o al gobernador regional rendir cuenta sobre su participación en el Consejo de Gobernaciones.

\item[k)] Aprobar, rechazar o proponer modificaciones al plan de manejo integrado de cuencas.

\item[l)] Pronunciarse en conjunto con los órganos competentes respecto de los procedimientos de evaluación ambiental.

\item[m)] Aprobar, modificar o rechazar el presupuesto regional, el plan de desarrollo regional y los planes de ordenamiento territorial.
...
\begin{itemize}
\item[a)] Crear, modificar y suprimir tributos de cualquier clase o naturaleza y los beneficios tributarios aplicables a estos, determinar su progresión, exenciones y proporcionalidad, sin perjuicio de las excepciones que establezca esta Constitución.
...
\item[c)] Establecer las condiciones y reglas conforme a las cuales las universidades y las empresas del Estado y aquellas en que este tenga participación puedan contratar empréstitos, los que en ningún caso podrán efectuarse con el Estado, sus organismos y empresas.

\item[d)] Instituir las normas sobre enajenación de bienes del Estado, de los gobiernos regionales o de las municipalidades y sobre su arrendamiento, títulos habilitantes para su uso o explotación y concesión.

\item[e)] Regular las capacidades de la defensa nacional, permitir la entrada de tropas extranjeras al territorio de la república y autorizar la salida de tropas nacionales fuera de él.

\item[f)] Establecer o modificar la división política o administrativa del país.

\item[g)] Señalar el valor, el tipo y la denominación de las monedas y el sistema de pesos y medidas.

\item[h)] Conceder indultos generales y amnistías, los que no procederán en caso de crímenes de guerra y de lesa humanidad.

\item[i)] Establecer el sistema de determinación de las remuneraciones de la Presidenta o del Presidente de la República y ministras o ministros de Estado, diputadas y diputados, gobernadoras y gobernadores y representantes regionales.

\item[j)] Singularizar la ciudad en que debe residir la Presidenta o el Presidente de la República, celebrar sus sesiones el Congreso de Diputadas y Diputados y la Cámara de las Regiones y funcionar la Corte Suprema.

\item[k)] Autorizar la declaración de guerra, a propuesta de la Presidenta o del Presidente de la República.

\item[l)] Fijar las bases de los procedimientos que rigen los actos de la Administración pública.

\item[m)] Establecer la creación y modificación de servicios públicos y empleos públicos, sean fiscales, autónomos o de las empresas del Estado , y determinar sus funciones y atribuciones.
...
\item[p)] Regular las demás materias que la Constitución exija que sean establecidas por una ley.
\end{itemize}
...
1. Solo son leyes de acuerdo regional:
    ...
    \begin{itemize}
    \item[a)] Las que reformen la Constitución.

    \item[b)] Las que regulen la organización, las atribuciones y el funcionamiento de los Sistemas de Justicia, del Poder Legislativo y de los órganos autónomos constitucionales.

    \item[c)] Las que regulen los estados de excepción constitucional.

    \item[d)] Las que creen, modifiquen o supriman tributos o exenciones y determinen su progresión y proporcionalidad.

    \item[e)] Las que directamente irroguen al Estado gastos cuya ejecución corresponda a las entidades territoriales.

    \item[f)] Las que implementen el derecho a la salud, derecho a la educación y derecho a la vivienda.

    \item[g)] La de Presupuestos.

    \item[h)] Las que aprueben los estatutos regionales.

    \item[i)] Las que regulen la elección, la designación, las competencias, las atribuciones y los procedimientos de los órganos y las autoridades de las entidades territoriales.

    \item[j)] Las que establezcan o alteren la división político-administrativa del país.

    \item[k)] Las que establezcan los mecanismos de distribución fiscal y presupuestaria y otros mecanismos de compensación económica entre las distintas entidades territoriales.

    \item[l)] Las que autoricen la celebración de operaciones que comprometan la responsabilidad patrimonial de las entidades territoriales.

    \item[m)] Las que autoricen a las entidades territoriales la creación de empresas públicas.
    ...
    \item[p)] Las que regulen las votaciones populares y escrutinios.

    \item[q)] Las que regulen las organizaciones políticas.

    \item[r)] Las demás que esta Constitución califique como de acuerdo regional.
    \end{itemize}
...
3. Las delegaciones no podrán extenderse a ámbitos de concurrencia presidencial necesaria; a la nacionalidad, la ciudadanía y las elecciones; a los ámbitos que sean objeto de codificación general, ni a la organización, las atribuciones y el régimen de los órganos nacionales o d e los Sistemas de Justicia.
...
3. Si la vacancia se produce faltando menos de dos años para la próxima elección presidencial, la Presidenta o el Presidente será elegido por el Congreso de Diputadas y Diputados y l a Cámara de las Regiones, en sesión conjunta. El nombramiento se realizará dentro de los diez días siguientes a la fecha de la vacancia y quien resulte elegido asumirá su cargo dentro de los treinta días siguientes. Para efectos de su reelección, este período presidencial se considerará como uno completo.
...
\begin{itemize}
\item[a)] Cumplir y hacer cumplir la Constitución, las leyes y los tratados internacionales, de acuerdo con sus competencias y atribuciones.

\item[b)] Dirigir la Administración del Estado.

\item[c)] Nombrar y remover a las ministras y ministros de Estado, a las subsecretarias y subsecretarios y a las demás funcionarias y funcionarios que corresponda, de acuerdo con la Constitución y la ley. Estos cargos son de su exclusiva confianza y quienes los desempeñen se mantendrán en sus puestos mientras cuenten con ella.

\item[d)] Conducir las relaciones exteriores, suscribir y ratificar los tratados, convenios o acuerdos internacionales, nombrar y remover a embajadoras y embajadores y jefas y jefes de misiones diplomáticas.

\item[e)] Declarar los estados de excepción constitucional en los casos y formas que se señalan en la Constitución y la ley.

\item[f)] Concurrir a la formación de las leyes y promulgarlas, conforme a lo que establece la Constitución.

\item[g)] Dictar decretos con fuerza de ley, previa delegación del Congreso de Diputadas y Diputados, conforme a lo que se establece en la Constitución.

\item[h)] Ejercer la potestad reglamentaria de conformidad con la Constitución y la ley.

\item[i)] Ejercer permanentemente la jefatura suprema de las Fuerzas Armadas, disponerlas, organizarlas y distribuirlas para su desarrollo y empleo conjunto.

\item[j)] Designar y remover al jefe del Estado Mayor Conjunto, a los comandantes en jefe de las Fuerzas Armadas, y disponer los nombramientos, ascensos y retiros de los oficiales de las Fuerzas Armadas.

\item[k)] Conducir la seguridad pública y designar y remover a los integrantes del alto mando policial.

\item[l)] Nombrar a la contralora o al contralor general conforme a lo dispuesto en la Constitución.

\item[m)] Participar en los nombramientos de las demás autoridades en conformidad con lo establecido en la Constitución.
...
\item[p)] Presentar anualmente el proyecto de Ley de Presupuestos.

\item[q)] Pedir, indicando los motivos, que se cite a sesión especial al Congreso de Diputadas y Diputados o a la Cámara de las Regiones. En tal caso, la sesión deberá celebrarse a la brevedad posible.

\item[r)] Las demás establecidas en la Constitución y la ley.
\end{itemize}
...
c) Efectuar una revisión integral de la gestión de todos los tribunales del Sistema Nacional de Justicia, a lo menos cada cinco años, la que incluirá audiencias públicas para determinar su correcto funcionamiento, conforme a lo establecido en l a Constitución y la ley. Esta revisión, en ningún caso, incluirá las resoluciones judiciales.
...
3. La ley determinará la organización y atribucion es de la Defensoría Penal Pública, debiendo garantizar su independencia externa.
...
2. Si un año antes de la fecha de elecciones para órganos colegiados previstas en esta Constitución no se ha adecuado la legislación electoral para la determinación territorial, así como para la integración paritaria de género y de escaños reservados para pueblos y naciones indígenas; las elecciones se regirán, por única vez, por las siguientes reglas:
    ...
    a) El Congreso de Diputadas y Diputados estará compuesto por 155 representantes, más los representantes de escaños reservados para pueblos y naciones indígenas. Para la definición de los distritos electorales se seguirá lo dispuesto en los artículos 187 y 188 de la ley Nº18.700, cuyo texto refundido, coordinado y sistematizado fue fijado por el decreto con fuerza de ley Nº 2, de 2017, del Ministerio Secretaría General de la Presidencia.
...
2. El Poder Legislativo deberá concluir la tramitación de estos proyectos en un plazo no superior a veinticuatro meses contados des de la fecha de su presentación.
...
1. En el plazo de dieciocho meses desde la entrada en vigencia de esta Constitución, el Presidente de la República deberá presentar un proyecto de ley que adecúe la legislación laboral según lo dispuesto en el artículo 47 del capítulo sobre Derechos Fundamentales y Garantías.

2. En el plazo de veinticuatro meses desde la entrada en vigencia de esta Constitución, el Presidente de la República deberá presentar un proyecto de ley que adecúe la legislación laboral, según lo dispuesto en el artículo 46 y 48 del capítulo sobre Derechos Fundamentales y Garantías.
...
Gloria Alvarado Jorquera                        Julio Álvarez Pinto
Rodrigo Álvarez Zenteno                         Amaya Alvez Marín
...
Miguel Ángel Botto Salinas                      Carol Bown Sepúlveda
